...
class RegressionNet(Network):
    ...
    def forward(self, X):
        ...
        y1, cache_sigmoid = sigmoid_forward(z1)
        y2, cache_affine2 = affine_forward(y1, W2, b2)
    ...
    def backward(self, dy):
        ...
        dy1 = sigmoid_backward(dX2, cache_sigmoid)
        dX1, dW1, db1 = affine_backward(dy1, cache_affine1)
